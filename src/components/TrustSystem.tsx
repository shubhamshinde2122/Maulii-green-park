            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px] md:h-[400px]">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-[url('/images/client/uploaded_image_4_1767759122908.jpg')] bg-cover bg-center opacity-40 grayscale-0 [@media(hover:hover)]:grayscale [@media(hover:hover)]:group-hover:grayscale-0 transition-all duration-700" />
