                        ...
                        >
                            ...
                            <div className="relative aspect-square md:aspect-[4/3] bg-charcoal rounded-sm overflow-hidden group border border-mist/10">
                                <img
                                    ...
                                    className="w-full h-full object-cover grayscale-0 [@media(hover:hover)]:grayscale [@media(hover:hover)]:group-hover:grayscale-0 transition-all duration-700 opacity-80 group-hover:opacity-100"
                                />
