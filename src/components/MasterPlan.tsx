            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 relative aspect-[4/3] min-h-[400px] bg-charcoal rounded-sm overflow-hidden border border-mist/20 group">
                        ...
                        <div className="absolute inset-0 opacity-60 bg-[url('https://images.unsplash.com/photo-1558036117-15d82a90b9b1?q=80&w=2560&auto=format&fit=crop')] bg-cover bg-center transition-all duration-700"
                            style={{ filter: activeId ? "brightness(0.3) grayscale(0.2)" : "brightness(0.6) grayscale(1)" }}
                        />
